...
This note considers the possibility of making Muon even more Muon-like, damping the top singular modes or growing the ~~small~~ intermediate[^2] ones. Contra-Muon mainly addresses the relative constributions among the top singular modes. whereas Soft-Muon with damps smaller singular modes relative to standard Muon.
...
[^1]: Added HTMuon citation, thanks Tianyu Pang for the reference
